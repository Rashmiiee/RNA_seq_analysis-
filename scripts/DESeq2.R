...
#countdata <- subset(countdata, select = -SRR18396493)
...
#Before running DESeq, create a DESeqDataSet object. This object holds the count data along with metadata about the samples (such as condition or treatment information).
dds <- DESeqDataSetFromMatrix(countData=countdata, colData=coldata, design=~condition)
dds
#normalize the count data, estimate dispersions, fit a statistical model, and perform differential expression analysis with DEseq(dds)
dds <- DESeq(dds)
